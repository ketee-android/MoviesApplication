...
import com.ketee_jishs.moviesapplication.adapter.RecyclerViewHorrorAdapter
import com.ketee_jishs.moviesapplication.databinding.FragmentHorrorFilmsBinding

class HorrorFilmsFragment : Fragment(), RecyclerViewHorrorAdapter.OnItemClickListener {
    lateinit var binding: FragmentHorrorFilmsBinding
    private val adapter = RecyclerViewHorrorAdapter(arrayListOf(), this)
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_horror_films, container, false)
        val viewModel: HorrorFilmsViewModel by lazy {
            ViewModelProviders.of(this).get(HorrorFilmsViewModel::class.java)
        }
        binding.viewModel = viewModel
        binding.executePendingBindings()

        binding.recyclerHorrorFilmsView.layoutManager =
            LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false)
        binding.recyclerHorrorFilmsView.adapter = adapter
        viewModel.horrorFilms.observe(
            this,
